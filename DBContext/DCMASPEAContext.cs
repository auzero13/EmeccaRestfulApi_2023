...
{
    public class DCMASPEAContext : DbContext
    {
        public DCMASPEAContext()
        {
        }

        public DCMASPEAContext(DbContextOptions<DCMASPEAContext> options): base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            var connectionString = configuration.GetConnectionString("AppConnection2");
